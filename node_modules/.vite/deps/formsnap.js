...
function Field($$anchor, $$props) {
  ...
  setFormField(field);
  legacy_pre_effect(
    () => (get(formErrors), get(formConstraints), get(formTainted), get(formData), deep_read_state(form())),
    () => {
      (() => {
        const tmp = form();
...
var root_4 = add_locations(template(`<div> </div>`), Field_errors.filename, [[49, 4]]);
...
var root_3 = add_locations(template(`<fieldset><!></fieldset>`), Fieldset.filename, [[40, 2]]);
...
var root_24 = add_locations(template(`<legend><!></legend>`), Legend.filename, [[30, 1]]);
...
function Element_field($$anchor, $$props) {
  ...
  legacy_pre_effect(
    () => (get(path), deep_read_state(name())),
    () => {
      (() => {
        const tmp_1 = splitArrayPath(name());
        set(path, tmp_1[0]);
        return tmp_1;
      })();
    }
  ...
  legacy_pre_effect(
    () => (deep_read_state(name()), $formData()),
    () => {
      set(value, getValueAtPath(name(), $formData()));
    }
  );
  legacy_pre_effect_reset();
  init();
